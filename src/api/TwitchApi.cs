...
using TwitchAPI.api.data;
using TwitchAPI.api.data.badges.data;
using TwitchAPI.api.data.badges.data.badge;
using TwitchAPI.api.data.requests;
using TwitchAPI.api.data.responses;
using TwitchAPI.api.data.responses.GetUserInfo;
using TwitchAPI.api.data.responses.SendMessage;
...
public class TwitchApi {
    private const int DEFAULT_CACHE_CAPACITY = 5;
    
    private readonly HttpClient _httpClient;
    private readonly Cache _cache;


    public TwitchApi(HttpClient? client = null, int cacheCapacity = DEFAULT_CACHE_CAPACITY) {
        if (cacheCapacity < 0) cacheCapacity = DEFAULT_CACHE_CAPACITY;
    ...
    public async Task<UserInfo?> GetUserInfo(string endpoint, string oauth, string clientId, EventHandler<string>? callback = null) {
        try {
    ...
    public async Task<SendMessageResponse?> SendReply(string message, string replyId, FullCredentials credentials, EventHandler<string>? callback = null) {
        try {
            if (string.IsNullOrEmpty(message)) {
                callback?.Invoke(null, "Message is empty.");
                return null;
    ...
    public async Task BanUser(string username, string message, FullCredentials credentials, EventHandler<string>? callback = null) {
        ...
        public async Task<bool> TimeoutUser(string userId, string message, TimeSpan durationSeconds, FullCredentials credentials, EventHandler<string>? callback = null) {
        try {
            var payload = new
                          {
                              data = new
    ...
    public async Task<bool> UpdateChannelInfo(string newTitle, string newGameId, FullCredentials credentials, EventHandler<string>? callback = null) {
        try {
            var requestBody = new 
                              {
                                      game_id = newGameId,
    ...
    public async Task<ChannelInfo?> GetChannelInfo(FullCredentials credentials, EventHandler<string>? callback = null) {
        try {
            using var requestMessage = new HttpRequestMessage();
            requestMessage.Method = HttpMethod.Get;
            requestMessage.RequestUri = new Uri($"https://api.twitch.tv/helix/channels?broadcaster_id={credentials.ChannelId}");
    ...
    public async Task<string?> FindGameId(string searchQuery, FullCredentials credentials, EventHandler<string>? callback = null) {
        try {
    ...
    private async Task<GameData?> SearchSingleGame(string gameName, FullCredentials credentials) {
        try {
    ...
    public async Task<bool> SetChannelRewardState(string rewardId, bool state, FullCredentials credentials, EventHandler<string>? callback = null) { 
        try {
            var requestBody = new 
                              {
                                  is_enabled = state,
    ...
    public async Task<bool> DeleteChannelReward(string rewardId, FullCredentials credentials, EventHandler<string>? callback = null) {
        try {
            using var requestMessage = new HttpRequestMessage();
            requestMessage.Method = HttpMethod.Delete;
            requestMessage.RequestUri = new Uri($"https://api.twitch.tv/helix/channel_points/custom_rewards?broadcaster_id={credentials.ChannelId}&id={rewardId}");
    ...
    public async Task<bool> SendWhisper(string userId, string message, FullCredentials credentials, EventHandler<string>? callback = null) {
        try {
            var requestBody = new { 
                                      message,
                                  };
    ...
    public async Task<string?> CreateClip(FullCredentials credentials, EventHandler<string>? callback = null) {
        try {
            using var requestMessage = new HttpRequestMessage();
            requestMessage.Method = HttpMethod.Post;
    ...
    public async Task<StreamResponse?> GetStreams(string username, FullCredentials credentials, EventHandler<string>? callback = null) {
        try {
    ...
    public async Task<string?> GetUsername(string userId, FullCredentials credentials, bool displayName = false, EventHandler<string>? callback = null) {
        ...
        public async Task<Badge[]?> ListGlobalBadges(FullCredentials credentials, EventHandler<string>? callback = null) {
        try {
            if (_cache.Badges.GlobalBadges != null) {
                return _cache.Badges.GlobalBadges;
            }
            ...
            if (response.IsSuccessStatusCode) {
                ...
                _cache.Badges.CacheGlobalEmotes(deserialized.Data);
